...
#### adding novalidte attribute in the form tag prevents browser validation from kicking in when we click on the submit button.
#### invoke onSubmit method and log form data
